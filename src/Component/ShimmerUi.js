...
const ShimmerUi = () => {
  return (
    ...
    <h3 className="font-bold px-2 py-1  whitespace-nowrap overflow-hidden"> </h3>
    <h3 className="px-2 font-bold py-1" ></h3>
    <h4 className=" px-2  font-light text-sm whitespace-nowrap overflow-hidden"></h4>
